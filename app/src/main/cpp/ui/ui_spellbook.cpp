...
UISpellbook::UISpellbook(const std::string& title)
    ...
    setTitleBarColor(glm::vec4(
        PlaceholderAssets::Colors::BROWN_ACCENT.x * 0.8f,
        PlaceholderAssets::Colors::BROWN_ACCENT.y * 0.6f,
        PlaceholderAssets::Colors::BROWN_ACCENT.z * 0.8f, 0.95f));
    setTitle(title);
...
void UISpellbook::renderSpellDetail() {
    ...
    UIDrawHelper::drawColoredQuad(detailX + 4.0f, ty, detailW - 8.0f, 1.0f,
        glm::vec4(PlaceholderAssets::Colors::BROWN_ACCENT.x, PlaceholderAssets::Colors::BROWN_ACCENT.y, PlaceholderAssets::Colors::BROWN_ACCENT.z, 1.0f),
