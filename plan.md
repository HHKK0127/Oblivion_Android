...
|--------|-------|-------|------------|------|
| `0x0015` | 17,529 | 20.17% | 20.17% | |
| `0x001C` | 10,876 | 12.51% | 32.68% | the fixed 4-byte marker |
| `0x0019` | 10,826 | 12.46% | 45.14% | argLength always 0 |
| `0x0016` | 10,776 | 12.40% | 57.53% | |
| `0x0010` | 4,344 | 5.00% | 62.53% | |
| `0x0011` | 4,344 | 5.00% | 67.53% | STOP terminator |
| `0x1039` | 3,479 | 4.00% | 71.53% | SetStage |
| `0x001D` | 2,393 | 2.75% | 74.29% | SCPT-only prologue |
| `0x0018` | 2,016 | 2.32% | 76.61% | |
| `0x105E` | 1,163 | 1.34% | 77.94% | |
| `0x1002` | 1,129 | 1.30% | 79.24% | |
| `0x1021` | 1,114 | 1.28% | 80.52% | |
| `0x100D` | 1,056 | 1.21% | 81.74% | |
| `0x0017` | 980 | 1.13% | 82.86% | |
...
**(3) The three owners have unrelated profiles**, so one global ranking would mis-order the work. SCPT is dominated by control syntax - `0x0015` 18.4% / `0x0019` 16.0% / `0x0016` 16.0% / `0x001C` 8.6% / `0x0010` 6.6% / `0x0011` 6.6%, over 60% together. QUST is dominated by `0x001C` alone (34.42%, then `0x0015` 9.67% / `0x1021` 4.48% / `0x105E` 4.42% / `0x1039` 3.76% / `0x1022` 3.22% / `0x1037` 3.02% / `0x1089` 2.76% / `0x109E` 2.71%). INFO is dominated by `0x0015` (40.43%, then `0x1039` 15.51% / `0x001C` 15.28% / `0x1002` 4.24% / `0x1052` 3.90% / `0x1053` 2.41%). **The highest-value single target is the `0x001C` operand rule** (12.51% overall, 34.42% of QUST, 15.28% of INFO), followed by the meanings of `0x0015` / `0x0016` / `0x0019`, which together are 45.03% of every instruction in the game.
