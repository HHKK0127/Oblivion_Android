...
- [x] **Localization** - Japanese + English (100+ UI translations, 28,686 JPWiki game strings; books, dialogue and quests resolve through it)
...
- [x] **多言語化** - 日本語＋英語（UI翻訳100以上、JPWikiゲーム文字列28,686件。書籍・対話・クエストも参照）
